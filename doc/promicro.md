...
- この状態でL型のType-Cケーブルを使う場合は下の写真のように、コネクタの突き出し量が12mm以上あるものを使用してください。

<img src="https://raw.githubusercontent.com/Lekipon/ASTRA515/master/doc/img/044.JPG" width="640" />

・余談ですが、写真のケーブルはダイソーで売ってるType-Cケーブルです。

<br>

<br>

## ProMicroの赤色LEDを消灯させる方法

- 標準添付のProMicroはVCCの赤色LEDの照度が強いため、マットのアクリルプレート越しでも目障りに感じる方もいるかと思います。
- その場合は、あくまで自己責任となりますが、LEDに繋がっている抵抗を除去してLEDを点灯しなくするという処置が可能です。これをするとスタンバイ消費電力も2mA程度の削減になります。
